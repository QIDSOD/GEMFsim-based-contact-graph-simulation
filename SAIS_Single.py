...
Para = Para_SAIS_Single(delta,beta, beta_a, kappa)
...
plt.plot(t,f[2,:],'g',label='Alerted')
# plt.plot(t,f[3,:],'g',label='Recovered')
# plt.savefig("SAIS.png")
...
plt.show()
# plt.savefig("SAIS_MonteCarlo.png")
...
plt.plot(T, StateCount[2,:]/N,'y',label='Alerted')
